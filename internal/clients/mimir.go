...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal mimir credentials as JSON"

	// Mimir provider configuration keys
	keyURI             = "uri"
	keyRulerURI        = "ruler_uri"
	keyAlertmanagerURI = "alertmanager_uri"
	keyDistributorURI  = "distributor_uri"
	keyOrgID           = "org_id"
	keyToken           = "token"
